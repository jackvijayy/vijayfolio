  ...
  return (
    <div className='h-[80vh] bg-black '>
     <div className='flex justify-between items-center'>
      ...
      <Link href='/projects'><Button className='w-20 text-sm'>For more</Button></Link>
      </div>
            ...
            {projects.map(({ id,title,des,img,iconLists,link })=>(
                ...
                >
                    ...
                    <div className=" p-1 w-full h-full overflow-hidden ">
                        <Image src={img} alt="thumbnail" className=" w-full h-full"  width='100' quality={100} priority placeholder="blur" blurDataURL="..." height='100'  />
                    ...
                    <div className="flex items-center justify-center">
                        {iconLists.map((icon,index)=>(
                            <div key={index} className="flex items-center rounded-full  border border-gray-800 -translate-x-6 gap-3">
